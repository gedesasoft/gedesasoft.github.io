...
var message='<img src="images/leeg.gif" border=0 width=227 height=13><img onClick="verberg()" src="images/sluiten.gif" border=0 width=13 height=13 alt="Sluiten"><br><a href="wiskoef/info_the_end.htm" target="doel"><img src="the_end.jpg" border=0 width=240 height=180 alt="The end"></a>'
